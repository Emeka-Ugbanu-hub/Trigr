...
var AnimateParagraph = forwardRef(function AnimateParagraph2({
  value,
  trigger = "change",
  ...
  const animate = useCallback(() => requestRun("manual"), [requestRun]);
  ...
  const handleMouseLeave = useCallback(() => onHoverEnd == null ? void 0 : onHoverEnd(), [onHoverEnd]);
  useEffect(() => {
    var _a2;
...
export { Animate, AnimateParagraph, EASE_IN, EASE_IN_OUT, EASE_OUT, SMOOTH, SPRING, paragraph_default as default, presets };
