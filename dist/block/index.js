import { forwardRef, useRef, useState, useMemo, useCallback, useImperativeHandle, useEffect, useLayoutEffect, createElement, Children } from 'react';
    ...
    "div",
    {
      ...
      children: items.map((child, i) => /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx("div", { className: "trigr-parallax-layer", children: child })
        },
        i
      ))
    }
...
var AnimateBlock = forwardRef(function AnimateBlock2({
  value,
  trigger = "change",
  ...
  const play = useCallback((source = activeTrigger, presetName) => {
    var _a2;
...
export { Animate, AnimateBlock, Parallax, block_default as default };
